...
public class BeanUtils {
    ...
    /**
     * object copy is null,so not copy
     * @param dest
     * @param orig
     * @param isnull
     */
    public static void copyProperties(Object dest, Object orig,Boolean isnull)
            throws IllegalAccessException, InvocationTargetException {
        BeanUtilsBean.getInstance().copyProperties(dest, orig,isnull);
    }
    /**
